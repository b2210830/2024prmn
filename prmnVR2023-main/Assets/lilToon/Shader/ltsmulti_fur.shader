Shader "Hidden/lilToonMultiFur"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Replace keywords
            #include "Assets/lilToon/BaseShaderResources/Includes/lil_replace_keywords.hlsl"

            //----------------------------------------------------------------------------------------------------------------------
            // Pass
            #include "Assets/lilToon/BaseShaderResources/Includes/lil_pipeline_brp.hlsl"
            #include "Assets/lilToon/BaseShaderResources/Includes/lil_common.hlsl"
            // Insert functions and includes that depend on Unity here
            

            #include "Assets/lilToon/BaseShaderResources/Includes/lil_pass_forward.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/lilToon/BaseShaderResources/Includes/lil_pass_forward_fur.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/lilToon/BaseShaderResources/Includes/lil_pass_shadowcaster.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/lilToon/BaseShaderResources/Includes/lil_pass_meta.hlsl"
