Shader "_lil/[Optional] lilToonFakeShadow"
{
    ...
    SubShader
    {
        ...
        HLSLINCLUDE
            ...
            #pragma skip_variants VERTEXLIGHT_ON LIGHTPROBE_SH _ADDITIONAL_LIGHTS_VERTEX _ADDITIONAL_LIGHTS
        ...
        Pass
        {
            ...
            #include "Assets/lilToon/BaseShaderResources/Includes/lil_pass_forward_fakeshadow.hlsl"
