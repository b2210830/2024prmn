...
using UnityEngine;
using UniRx;
using UnityEngine.SceneManagement;//wip2023
...
namespace NsUnityVr.Systems
{
    ...
    public class GameManager : SingletonMonoBehaviour<GameManager>
    {
        ...
        private void Result()
        {
            ...
            {
				Rensyu_MaintenanceManager.Instance.SetUpResultState();//wip2023
            }
            else
            {
				MaintenanceManager.Instance.SetUpResultState();//wip2023
            }
			//wip2023
